...
\item \href{https://github.com/TeamCOMPAS/COMPAS}{{\bf COMPAS}} --- (90 stars / 80 forks) \\
COMPAS rapid binary population synthesis code \href{http://compas.science}{[docs]}

\item \href{https://github.com/Adam-Boesky/long_transients}{{\bf long{\_}transients}} --- (0 stars / 0 forks) \\
Finding long-duration transient candidates 

\item \href{https://github.com/alexandergagliano/Prost}{{\bf Prost}} --- (9 stars / 5 forks) \\
A probabilistic host-galaxy association code.  

\item \href{https://github.com/jdinovi/HOOTSim}{{\bf HOOTSim}} --- (2 stars / 0 forks) \\
N-Body Simulator 

\item \href{https://github.com/Adam-Boesky/ztforce}{{\bf ztforce}} --- (1 stars / 0 forks) \\
